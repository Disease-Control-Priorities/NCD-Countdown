...
# CPI adjusted
cpi <- read.csv("NCD_data_0706/CPI_WB_2018_added.csv", stringsAsFactors=F)
#used to be CPI_WB_2018_added2.csv but can't find that file

# GNI
GNI <- read.csv("NCD_data_0706/GNI_WB_USD_atlas_add3.csv", stringsAsFactors=F)
...
# Adjustment database
    ...
    # Add ancillary + above HF costs
     ...
     file.name <- paste0("NCD_data_0706/test_country_outputs/UC/",selected_country,"_adjusted_uc_",UC_Years,".csv")
     ...
     file.name <- paste0("NCD_data_0706/test_country_outputs/UC/",selected_country,"_adjusted_uc_merged_",UC_Years,".csv")
...
# full data -----------------------
  ...
  file.name <- paste0("NCD_data_0706/test_country_outputs/",selected_country,"_all_by_intervention_year",".csv")
...
file.name <- paste0("NCD_data_0706/test_country_outputs/",selected_country,"_total_cost_2030_intervention",".csv")
...
file.name <- paste0("NCD_data_0706/test_country_outputs/",selected_country,"_total_cost_2030",".csv")
...
file.name <- paste0("NCD_data_0706/test_country_outputs/",selected_country,"_increment_cost_2020_2030",".csv")
...
file.name <- paste0("NCD_data_0706/test_country_outputs/",selected_country,"_ICER_2020_2030",".csv")
...
file.name <- paste0("NCD_data_0706/test_country_outputs/",selected_country,"_ICER_2030",".csv")
