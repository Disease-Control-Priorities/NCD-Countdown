...
makeplot <- function(tp, df){
   ...
   levs = c("Historical", "Baseline", "Adjust to 90%")
...
pdf(file="Figures/lpc.adj.90a_0819.pdf", width = 13, height = 9)
makeplot("box", lpc.plot)
dev.off()

pdf(file="Figures/lpc.adj.90b_0819.pdf", width = 13, height = 9)
makeplot("ridge", lpc.plot)
dev.off()
